...
# Before you start:
# Download the file "national_clinton_trump_6_20_2016.csv" 
...
# knitr is useful for problem sets that require showing your code (it is also required to submit homeworks in RMarkdown)
# for bigger projects: use a dependency manager (packrat https://rstudio.github.io/packrat/) for projects 
...
# The ls() function returns a character vector of all the named objects 
# visible in the environment where it is called and they are 
# assigned to a list.
# The rm() function means remove(base) which is used to remove
# objects from the specified environment in this case the current workspace.
...
# When creating any data frame in R that has textual data, R
# treats the data as categorical and creates factors on it.
...
# of unique values such as Male, Female and True, False etc.
...
# If the above function is not working for you try the following
# commands
